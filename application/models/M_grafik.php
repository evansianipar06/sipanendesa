...
class M_grafik extends CI_Model{
	function statistik_stok(){
        $query = $this->db->query("SELECT kategori_nama,SUM(panen_stok) AS tot_stok FROM tbl_panen JOIN tbl_kategori ON panen_kategori_id=kategori_id GROUP BY kategori_nama");
