    ...
    <div class="container" style="font-family:Times New Roman;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p> Kepada : Kepala Desa</br>Dari : <?php echo $this->session->userdata('nama');?> </p>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-12">
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/res_kades/tambah_feedback'?>">
