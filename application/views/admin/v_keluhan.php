    ...
    <div class="container" style="font-family:Times New Roman;">
        <div class="row">
            <div class="col-lg-12">
                ...
                <h1 class="page-header">Buat Keluhan</h1>
                <p align="left">Tanggal : <?php echo date('d-M-Y')?>
                <p> Kepada : Admin</br>Dari : <?php echo $this->session->userdata('nama');?> </p>
            </div>
        </div>

        <div class="row">
            <div class="col-lg-12">
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/keluhan/tambah_keluhan'?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <h4>Keluhan</h4>
                            <div>
                                <textarea name="keluhan" class="form-control" type="text" placeholder="Apa Keluhan Anda ???" style="width:450px; height: 100px;"></textarea>
                            </div>
                        </div>
