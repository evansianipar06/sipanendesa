...
<body>
   ...
   ?>
    ...
    <div class="container" style="font-family:Times New Roman;">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Data Grafik
                </h1>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped table-hover dt-responsive " id="mydata">
                ...
                <tbody>               
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Grafik Stok Panen</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-primary" href="<?php echo base_url().'admin/grafik/graf_stok_panen'?>" target="_blank"><span class="fa fa-eye"></span> View</a>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align:center;vertical-align:middle">2</td>
                        <td style="vertical-align:middle;">Grafik Penjualan Panen PerBulan</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-primary" href="#lap_jual_perbulan" data-toggle="modal"><span class="fa fa-eye"></span> View</a>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align:center;vertical-align:middle">3</td>
                        <td style="vertical-align:middle;">Grafik Penjualan Panen PerTahun</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-primary" href="#lap_jual_pertahun" data-toggle="modal"><span class="fa fa-eye"></span> View</a>
                        </td>
                    </tr>             
                </tbody>
            </table>
                ...
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/grafik/graf_penjualan_perbulan'?>" target="_blank">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-primary"><span class="fa fa-eye"></span> Lihat</button>
                        </div>
                    </form>
                </div>
            </div>
