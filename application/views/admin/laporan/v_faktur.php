...
<head>
    <title>Faktur Penjualan Panen</title>
    <meta charset="utf-8">
...
<body onload="window.print()">
        ...
        <table style="border-collapse: collapse; width: 90%;" border="0">
            <tr>
                <td style="text-align: center;">
                    ...
                    <span  style="font-size:  18pt;  font-weight:  bold;  color: red;">Smart Village</span><br>
                    <span style="font-size: 12pt; font-weight: bold; font-style: italic;">Jl. Sisimangaraja 20, Balige</span>
                </td>
            </tr>
        </table>    
        </td>
    ...
    <tbody>
        ...
        $no=0;
            foreach ($data->result_array() as $i) {
                ...
                $nabar=$i['d_jual_panen_nama'];
                $satuan=$i['d_jual_panen_satuan'];
                
                $harjul=$i['d_jual_panen_harjul'];
                $qty=$i['d_jual_qty'];
    ...
    <tr>
        <td>
            ...
            <strong>*Panen   yang   sudah   dibeli   tidak dapat   ditukarkan kembali</strong>
        </td>
    </tr>
