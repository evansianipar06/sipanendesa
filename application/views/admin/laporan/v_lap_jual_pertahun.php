...
<head>
    <title>Laporan Penjualn Per Tahun</title>
    <meta charset="utf-8">
...
<tr>
    <td colspan="2" style="width:800px;paddin-left:20px;"><center><h4>LAPORAN PENJUALAN PANEN TAHUN <?php echo $b['tahun'];?></br>DI SMART VILLAGE</h4></center><br/></td>
</tr>
...
<?php 
    ...
    if($group=='-' || $group!=$d['bulan']){
        $bulan=$d['bulan'];
        $query=$this->db->query("SELECT jual_nofak,DATE_FORMAT(jual_tanggal,'%M %Y') AS bulan,DATE_FORMAT(jual_tanggal,'%d %M %Y') AS jual_tanggal,d_jual_panen_id,d_jual_panen_nama,d_jual_panen_satuan,d_jual_panen_harpok,d_jual_panen_harjul,d_jual_qty,d_jual_diskon,SUM(d_jual_total) AS total FROM tbl_jual JOIN tbl_detail_jual ON jual_nofak=d_jual_nofak WHERE DATE_FORMAT(jual_tanggal,'%M %Y')='$bulan'");
        $t=$query->row_array();
        $tots=$t['total'];
        if($group!='-')
        echo "</table><br>";
...
echo "<tr style='background-color:#ccc;'>
    ...
    <td width='30%' align='center'>Nama Panen</td>
...
$nomor=1;
    ...
    $group=$d['bulan'];
        ...
        <tr>
                ...
                <td style="vertical-align:top;padding-left:5px;"><?php echo $d['d_jual_panen_id']; ?></td>
                <td style="vertical-align:top;padding-left:5px;"><?php echo $d['d_jual_panen_nama']; ?></td> 
                <td style="vertical-align:top;padding-left:5px;"><?php echo $d['d_jual_panen_satuan']; ?></td>
                <td style="vertical-align:top;padding-left:5px;text-align:right;"><?php echo 'Rp '.number_format($d['d_jual_panen_harjul']); ?></td>
