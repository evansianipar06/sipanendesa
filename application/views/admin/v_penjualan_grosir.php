   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <table>
                <tr>
                    <td style="width:760px;" rowspan="2"><button type="submit" class="btn btn-primary btn-lg"> Simpan</button></td>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p style="text-align:center;">Copyright &copy; <?php echo '2020';?> by RDY</p>
                </div>
            </div>
            <!-- /.row -->
        </footer>
